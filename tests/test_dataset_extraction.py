...
class TestDatasetExtraction(unittest.TestCase):
    ...
    def test_random_strategy(self, mock_load_data):
        ...
        np.random.seed(42)
        subvolume2, is_valid2, status2 = dataset._extract_subvolume_with_validation(
            self.tomogram_array, 16, 16, 16
        )
    ...
    def test_jittered_strategy(self, mock_load_data):
        ...
        centered_subvolume, _, _ = centered_dataset._extract_subvolume_with_validation(
            self.tomogram_array, 16, 16, 16
        )
