...
from copick_torch import SimpleCopickDataset, MinimalCopickDataset, setup_logging
...
def main():
    ...
    print(f"  SimpleCopickDataset: {sorted(list(simple_keys))}")
    print(f"  MinimalCopickDataset: {sorted(list(minimal_keys))}")
    ...
    print(f"  SimpleCopickDataset: {sorted(list(simple_examples.keys()))}")
    print(f"  MinimalCopickDataset: {sorted(list(minimal_examples.keys()))}")
