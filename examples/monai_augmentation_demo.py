#!/usr/bin/env python
"""
Demonstration of the MONAI-based Fourier domain augmentation in copick-torch.

This script shows how to use the MONAI-based FourierAugment3D class in copick-torch
...
def main():
    """Main function to demonstrate MONAI-based Fourier augmentation."""
    ...
    # Create the MONAI Fourier augmenter
    fourier_aug = FourierAugment3D(
        freq_mask_prob=0.3,
        phase_noise_std=0.1,
        intensity_scaling_range=(0.8, 1.2)
    ...
    visualize_volumes(
        ...
        ['Original', 'MONAI Fourier Augmented'],
        save_path='augmentation_output/monai_volume_comparison.png'
    )
    ...
    visualize_fourier_spectrum(
        volume, 
        augmented_volume,
        save_path='augmentation_output/monai_fourier_spectrum_comparison.png'
    )
